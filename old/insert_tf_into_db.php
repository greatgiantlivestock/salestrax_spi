                ...
                if($trim =="TF"){
                    ...
                    while ($line = fgets($fh)) {
                        if(strlen($line)>229){
                            ...
                            $sql = "INSERT INTO tukar_faktur_pending(VBELN,POSNR,LFDAT,WADAT_IST,BLDAT,VSTEL,VTEXT,KUNNR,NAME,KUNAG,NAME1,MATNR,ARKTX,LFIMG,MEINS,VBELN_INV,FKDAT_INV,STATS,date_update)
                                    values ('$VBELN','$POSNR','$LFDAT','$WADAT','$BLDAT','$VSTEL','$VTEXT','$KUNNR','$NEWNAME','$KUNAG','$NEWNAME1','$MATNR','$ARKTX','$LFIMG','$MEINS','$VBELN_INV','$FKDAT_INV','$STATS','$date_update')";
