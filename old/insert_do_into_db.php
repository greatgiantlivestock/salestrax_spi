                ...
                if($trim =="DG"){
                    ...
                    while ($line = fgets($fh)) {
                        if(strlen($line)>229){
                            ...
                            // $sql = "INSERT INTO do_gantung(VBELN,POSNR,LFDAT,WADAT_IST,BLDAT,VSTEL,VTEXT,KUNNR,NAME,KUNAG,NAME1,MATNR,ARKTX,LFIMG,MEINS,STATS,date_update)
                            ...
                            $conn = mysqli_connect("localhost","gred3696_ms","moha11mmad","gred3696_do_gantung");
                            $sql = "INSERT INTO do_gantung(VBELN,POSNR,LFDAT,WADAT_IST,BLDAT,VSTEL,VTEXT,KUNNR,NAME,KUNAG,NAME1,MATNR,ARKTX,LFIMG,MEINS,SNAME,STATS,date_update)
                    ...
                    if(!$linecount==0){
                        ...
                        include "push_notification_do.php";
                    }
                    fclose($fh);
                }
            }
