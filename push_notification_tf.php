...
mysqli_close($conn);
	$message = array("message" => "Data Tukar Faktur Pending di server telah diperbarui, silahkan tekan tombol refresh untuk melakukan update.");
	// $title = array("title" => "Data Tukar Faktur Pending di Server Telah Diperbarui");
